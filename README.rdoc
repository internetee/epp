...
Originally *EPP v1.3.1* by {Ultraspeed}[http://ultraspeed.co.uk]. This fork is maintained by {Estonian Internet (.ee)}[https://internet.ee]. Current release: see +VERSION+ or RubyGems.
